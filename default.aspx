<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="NBFC_App___dev._default" %>
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" runat="server">                            
                            <ul id="progressbar">
                                <li class="active" id="personal"><strong>Register</strong></li>
                                <li id="account"><strong>Verify OTP</strong></li>
                                <!--<li id="personal"><strong>Personal</strong></li>-->                               
                            </ul>
                            <fieldset>
                                <div class="form-card">
                                    <div><h2 class="title fs-title" id="header">Fill all form field to go to next step</h2></div>
                                    <div><h2 class="title fs-title" id="header2">Login</h2></div>                                   
                                    <asp:TextBox ID="mnumber"  placeholder="Mobile No." runat="server"></asp:TextBox>
                                    <asp:TextBox ID="email" placeholder="Email ID" runat="server"></asp:TextBox>
                                    <asp:TextBox ID="fullname" placeholder="Full Name" runat="server"></asp:TextBox>
                                    <asp:TextBox ID="idvar" runat="server" hidden="true"></asp:TextBox>
                                    <asp:TextBox ID="temp_data" runat="server" hidden="true"></asp:TextBox>
                                </div> 
                                <asp:Button ID="Button2" name="next" class="action-button" runat="server" Text="Next Step" OnClick="Button2_Click" />                                
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title">OTP Verification</h2>
                                    <h4 style="font-size: initial;"> Please enter the OTP sent to your email and mobile</h4>
                                    <asp:TextBox ID="OTP" placeholder="OTP" runat="server"></asp:TextBox>
                                </div>
                                <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                                <asp:Button ID="Button3" name="next" class="action-button" runat="server" Text="Verify" OnClick="Button3_Click" />
                            </fieldset>
                            <fieldset>
                                <div class="row" style="justify-content: center;"><asp:Button ID="Apply_for_Loan" name="next" class="action-button but-cls" runat="server" Text="Apply For Loan" OnClick="Apply_for_Loan_Click" /></div>
                                <div class="row" style="justify-content: center;"><asp:Button ID="Go_to_dashboard" name="next" class="action-button but-cls" runat="server" Text="My Profile" OnClick="Go_to_dashboard_Click" /></div>
                            </fieldset>
                            <!--<fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title">Personal Information</h2>
                                    <asp:TextBox ID="TextBox1" placeholder="Mobile No." runat="server"></asp:TextBox>
                                    <asp:TextBox ID="TextBox2" placeholder="Email ID" runat="server"></asp:TextBox>                                    
                                    <asp:TextBox ID="Loan_Amount" placeholder="Loan Amount" runat="server"></asp:TextBox>
                                    <asp:TextBox ID="Loan_Term" placeholder="Loan Term(in days)" runat="server"></asp:TextBox>
                                    ...
                                    <asp:DropDownList ID="Industry_type" class="dropdowncls" runat="server">
                                        <asp:ListItem Enabled="true" Text="Industry" Value="-1"></asp:ListItem>
                                ...
                                <input type="button" name="previous" class="previous action-button-previous" value="Previous" /> 
                                <!--<input id="step2_next" type="button" name="next" class="next action-button" value="Next Step" />
